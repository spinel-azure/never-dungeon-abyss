...
export const EFFECT_PART_TYPES = Object.freeze({
  ...
  popup: { label: "ダメージ数字", defaults: { color: "#ffffff", text: "999", fontSize: 72, rise: 100, outlineColor: "#161616" } },
  shake: { label: "画面振動", defaults: { strength: 14, frequency: 28 } }
});

export function createEffectDefinition(name = "NEW EFFECT") {
  return { version: EFFECT_SCHEMA_VERSION, id: "new_effect", name, width: 960, height: 540, duration: 1200, background: "#10151b", parts: [] };
}
