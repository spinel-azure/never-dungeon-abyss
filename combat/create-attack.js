...
export function createNormalAttack({ weapon, weaponId, weaponEnhancement = 0, skillIds = [] } = {}) {
  ...
  return {
    ...
    hitCount: resolvedWeapon.normalAttackHitCount ?? type.hitCount,
    hitElements: resolvedWeapon.normalAttackElements,
    powerPerHit: resolvedWeapon.normalAttackPowerPerHit ?? type.powerPerHit,
