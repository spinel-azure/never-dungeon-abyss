...
export function setDungeonColors({ wall, floor } = {}, { save = false } = {}) {
  if (["default", "stone", "red", "blue", "green", "yellow", "white", "black"].includes(wall)) menu.wallColor = wall;
  if (["default", "red", "blue", "green", "yellow", "purple", "white", "black"].includes(floor)) menu.floorColor = floor;
  applyWallColor();
  applyFloorColor();
  updateDebugStates();
