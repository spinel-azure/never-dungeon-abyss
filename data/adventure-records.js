...
export function getAdventureChronicle(character) {
  ...
  const milestones = [
    ...
    ["mimic", "黒い箱の怪物を討伐した", flags.boss_quest_mimic_b6f_defeated || flags.quest_mimic_b6f_defeated, "B6Fの黒い箱に潜んでいた怪物を撃破した。", "？？？？？？――ビックリばこ"],
    ["maikaeferCollector", "マイケーファーを10匹討伐した", Number(flags.maikaefer_defeat_count) >= 10, "希少なマイケーファーを累計10匹討伐した。", "？？？？？？――昆虫採取"],
    ...
    ['verfolger', 'フェルフォルガーを討伐した', flags.achievement_verfolger_defeated, 'フェルフォルガーを倒した。', '？？？？？？――忍び寄る影'],
