...
export const NPC_STAGE_PASSIVES = Object.freeze({
  alec: Object.freeze({ id: "npc_flash_slash", name: "一閃", description: "追撃時8％で一撃死", instantDeathRate: 0.08 }),
  rebecca: Object.freeze({ id: "npc_assassination", name: "暗殺術", description: "連撃時各Hit4％で一撃死", instantDeathRate: 0.04 }),
  erika: Object.freeze({ id: "npc_goddess_breath", name: "女神の息吹", description: "5歩ごとにHP1回復", stepInterval: 5, hpRecovery: 1 }),
  johan: Object.freeze({ id: "npc_mana_activation", name: "マナ活性化", description: "5歩ごとにSP1回復", stepInterval: 5, spRecovery: 1 })
});
...
export const NPC_ADVANCED_GROWTH = Object.freeze({
  alec: Object.freeze({
    ...
    stage9: Object.freeze({ name: "一閃・極", description: "一撃死無効時に追撃威力1.5倍", immuneDamageMultiplier: 1.5 }),
  ...
  rebecca: Object.freeze({
    ...
    stage9: Object.freeze({ name: "暗殺術・極", description: "一撃死無効時に現HP5％ダメージ／ボス上限500", immuneCurrentHpDamageRate: 0.05, bossDamageMaximum: 500 }),
  ...
  erika: Object.freeze({
    ...
    stage9: Object.freeze({ name: "女神の息吹・極", description: "5歩ごとにHP2回復", hpRecovery: 2 }),
