...
for(const [id,duration,parts,popupTime] of [['tunguska',4600,16,3500],['apocalypse',5000,17,3900]]){
 ...
 assert.equal(registry[skill.presentationId||skill.id],`data/effects/${id}.json`);
 ...
 const c=createInitialCharacter({name:'Effects QA',job:'mage'});c.skillIds.push(id);c.sp=c.maxSp=200;c.int=30;c.agi=99;c.playerCharge={value:100,cooldown:0};
