export const KEY_ITEMS = Object.freeze({
  ...
  queen_necklace: Object.freeze({
    id: "queen_necklace",
    name: "女王の首飾り",
    description: "女王の物と思われる美しい首飾り。闇の中でも淡い光をたたえている。",
    sellable: false,
    consumable: false,
    version: 1
  }),
  ...
  red_rust_key_b79f: Object.freeze({
    id: "red_rust_key_b79f",
    name: "赤錆びた鍵",
    description: "B79Fで見つけた赤錆びた鍵。赤い扉を開けられそうだ。",
    sellable: false,
    consumable: true,
    version: 1
  }),
  red_rust_key_b99f: Object.freeze({
    id: "red_rust_key_b99f",
    name: "赤錆びた鍵",
    description: "B99Fで見つけた赤錆びた鍵。赤い扉を開けられそうだ。",
    sellable: false,
    consumable: true,
    version: 1
  }),
